            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="p-2">
                            <form class="form-horizontal" action="{{route('register')}}" method="post">
                                ...
                                <div class="mt-3">
                                    <button class="btn btn-primary btn-block waves-effect waves-light" type="submit">Register In</button>
                                </div>
                ...
                <div class="mt-5 text-center">
                    ...
                    <div>
                        ...
                        <p>© 2023 Skote. Crafted with <i class="mdi mdi-heart text-danger"></i> by Arif Hossen</p>
                    </div>
                </div>
